...
from torchid.ss.dt.estimators import LuenbergerStateEstimator
...
if __name__ == '__main__':
    ...
    state_estimator = LuenbergerStateEstimator(f_xu, g_x, n_u=1, n_y=1, n_x=2, flipped=True)

    # Setup optimizer
    optimizer = optim.Adam([
        {'params': model.parameters(), 'lr': lr},
        {'params': state_estimator.gain_net.parameters(), 'lr': lr},
    ], lr=lr)
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (batch_u, batch_y) in enumerate(train_loader):
            ...
            batch_x0 = state_estimator(batch_u[0:10, :], batch_y[0:10, :])
